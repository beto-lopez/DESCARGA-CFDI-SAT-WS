...
public class SvcParseException extends WebServiceException {
   ...
   /**
    * Constructs a new SvcParseException with the specified detail message
    ...
    */
    ...
    /**
     * Constructs a new SvcParseException with the specified cause and a detail
    ...
    /**
     * Constructs a new SvcParseException with the specified detail message and cause
     * 
     * @param message The detail message which is later retrieved using the
     *                <code>getMessage</code> method
